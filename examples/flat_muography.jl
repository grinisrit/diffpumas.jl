#!/usr/bin/env julia
"""
flat_muography.jl — Flat-geometry muon flux muography studies
...
This script demonstrates muography techniques with flat/cubic rock geometries:
...
Usage:
    julia --project=. examples/flat_muography.jl --output-dir PATH [OPTIONS]
...
Example:
    julia --project=. examples/flat_muography.jl --output-dir examples/flat_muography --samples 2000
"""
...
function main()
    ...
    println("=" ^ 60)
    println(" DiffPumas — Flat-Geometry Muography Studies")
    println("=" ^ 60)
    println()
