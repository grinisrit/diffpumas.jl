# Atomic shell occupancy and energy data from Geant4 10.7 (G4AtomicShells)
# Ported from PUMAS C library (pumas.c lines 12699-13009)

const _ATOMIC_SHELL_OCCUPANCY = UInt8[
...
const _ATOMIC_SHELL_ENERGY = Float32[
